const tools = ['intent.candidate.save.status', 'intent.candidate.read', 'intent.overlap.check', 'projection.snapshot.read', 'projection.changes.read', 'intent.brief.catalog', 'intent.brief.read', 'intent.brief.artifacts', 'intent.brief.decisions', 'intent.brief.decision.evidence', 'intent.brief.preview', 'intent.brief.destination', 'intent.brief.save.status'] as const;
