const tools = ['projection.snapshot.read', 'projection.changes.read', 'intent.brief.catalog', 'intent.brief.read', 'intent.brief.decisions', 'intent.brief.preview', 'intent.brief.destination', 'intent.brief.save.status'] as const;
