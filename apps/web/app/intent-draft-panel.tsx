...
export default function IntentDraftPanel({ organizationId, productId, repository, subject, expiresAt, content, locked, onRestore }: {
  ...
  useEffect(() => {
    ...
    editor.current = current; setView(current.snapshot()); setDraftId('');
