...
async function component() {
  ...
  const panel = await compile('intent-draft-panel', { './intent-draft-editor': local('intent-draft-editor'), './intent-draft-transport': local('intent-draft-transport'), './brief-markdown': markdown });
