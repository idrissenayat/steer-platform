...
export interface SessionTestHarness {
  ...
  createReceiptProjection?: (reader: ArtifactReader, path: string, revision: string, observation: unknown) => Promise<{ services: ToolServices; advance(): Promise<void>; close(): Promise<void> }>;
