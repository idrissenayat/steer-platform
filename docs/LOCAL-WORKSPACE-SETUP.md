...
**Migration hold (0209, extended by 0213):** the development journal contains eleven migrations.
New 0007/0008 execution and 0009/0010 encrypted-original migrations run only in disposable tests;
...
baseline expects seven; the expanded eleven-migration set is explicitly held.
