...
|---|---|---|
| R5-001 lifecycle | 0059/0058/0060 composed in 0061; 0068 retention; 0070 precision; 0071 ordering; 0072 three-key matrix; 0073/0074 raw grant/batch; 0075 single recovery checkpoint | Repeated-checkpoint/crash recovery (0075 PLAN), real store integration; future-retention/registry, reference revocation, unranked ties/auxiliary times and normative matrix; independent/protected review |
...
Next bounded work is repeated raw checkpoint/crash recovery, followed by
...
0061–0075 are development candidates and verification increments,
...
preflight-critic-r5.json in that same frozen directory, and intent/0056–0075.
