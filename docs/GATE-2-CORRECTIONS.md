...
| R5-002 full authority/time | 0058–0067 provide explicit-time candidates for all ten original signed public oracles, including accessibility; source/export/test inventory is in 0067 | Full behavioral/normative review, legacy observed-as-of versus archival/current-authority semantics and trusted runtime clock integration; complete-package independent review |
...
0061–0068 are composed development candidates,
...
preflight-critic-r5.json in that same frozen directory, and intent/0056–0068.
