...
|---|---|---|
| R5-001 lifecycle | 0059 event/history + 0058 human + 0060 shared actions composed in 0061; 0068 corrects earliest rebuildable/provenance rules with a closed derived manifest, all 16 current class outcomes and complete parent-capped positives | Finish future-retention/registry and reference-revocation completion, raw three-key inventory, nanosecond policy fidelity and full normative matrix; independent/protected review; no live execution claimed |
| R5-002 full authority/time | 0058–0067 provide explicit-time candidates for all ten original signed public oracles; 0069 adds exact nanosecond key/calendar primitives and policy bindings; source/export/test inventory is in 0067 | Explicit successor business/event precision contracts; full normative review; observed-as-of versus archival/current-authority semantics and runtime clocks; independent review |
...
Next bounded work is remaining lifecycle future-retention/reference/future-key
coverage, then migration compatibility/concurrency/checkpoint coverage and complete
...
0061–0069 are development candidates,
...
preflight-critic-r5.json in that same frozen directory, and intent/0056–0069.
