...
|---|---|---|
| R5-001 lifecycle | 0059/0058/0060 composed in 0061; 0068 corrects earliest/provenance rules with a closed manifest and all 16 current outcomes; 0070 adds full precise lifecycle comparisons | Finish future-retention/registry, reference revocation, raw three-key inventory/pre-terminal grant semantics, event ordinals/auxiliary times and normative matrix; independent/protected review |
...
0061–0070 are development candidates,
...
preflight-critic-r5.json in that same frozen directory, and intent/0056–0070.
