...
| C22 | I5 Save/reopen | Measured provider request load and end-to-end latency satisfy documented human-UX acceptance thresholds on the representative journey. | Pending | [0303](../intent/0303/EVIDENCE.md) adds the private native GitHub batch primitive in application source; it is not yet used by collectors or factories. Prior test-only [0301](../intent/0301/EVIDENCE.md)/[0302](../intent/0302/EVIDENCE.md) graphs retain separate source grants and elapsed lifetime. Independent production policies/key providers, complete lifecycle/authority and owned effect integration remain. Last full confirmation is 7,637; [next](../intent/0298/REQUEST-BUDGET-PLAN.md) is coherent integration and the unchanged full benchmark. Prior failures remain retained. |
