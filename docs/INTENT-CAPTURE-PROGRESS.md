...
| C22 | I5 Save/reopen | Measured provider request load and end-to-end latency satisfy documented human-UX acceptance thresholds on the representative journey. | Pending | [0296](../intent/0296/EVIDENCE.md) reduces preview to 4,017 attempts and first confirmation to 8,227 (about 19%); reconstructed/repeated confirmation use 8,199 / 8,197. Source review remains 210; preparation/start counts are unchanged. The authenticated synthetic save/recovery/reopen, 1,583 expanded broad tests, 233 supplemental tests and 88 prototype tests pass. Confirmation still downloads 344 repository blobs, so both body rereads and identity/records duplication need consolidation before the unchanged 200-attempt and full performance/live acceptance tests can pass. Prior delayed failure and unexplained 0289 recovery-unknown remain retained. |
