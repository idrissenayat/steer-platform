...
| C22 | I5 Save/reopen | Measured provider request load and end-to-end latency satisfy documented human-UX acceptance thresholds on the representative journey. | Pending | [0294](../intent/0294/EVIDENCE.md) reduces source review to 210 attempts, scope preparation to 844, first confirmation to 10,307, preview to 5,057 and drafting preparation to 4,350 / 3,900. Initial drafting start remains 7,871. The authenticated synthetic save/recovery/reopen passes; even source review remains above the 200-attempt limit, and the prior delayed failure remains retained. Full warmed/cold/concurrent performance and failure acceptance remain open. The earlier 0289 recovery-unknown observation remains retained and unexplained, not fixed by later passing runs. |
