...
| C22 | I5 Save/reopen | Measured provider request load and end-to-end latency satisfy documented human-UX acceptance thresholds on the representative journey. | Pending | [0288](../intent/0288/EVIDENCE.md) lowers initial drafting start to 23,064 requests (44.78% reduction); receipt recovery/repeated starts use 25,974. Scope preparation, source review and first confirmation stay at 9,598, 2,634 and 45,716. The [benchmark prefix](INTENT-CAPTURE-PERFORMANCE.md) still fails source review at the 200-attempt target; only draft-read targets passed previously. Later-stage, full failure/concurrency and issuer-latency coverage remain open. This remains unacceptable request load, not C22 completion. |
