...
| C22 | I5 Save/reopen | Measured provider request load and end-to-end latency satisfy documented human-UX acceptance thresholds on the representative journey. | Pending | [0291](../intent/0291/EVIDENCE.md) reduces source review from 2,634 to 317 attempts, scope preparation from 9,598 to 1,250, drafting preparation to 6,516 / 5,846, initial drafting start to 11,537 and first confirmation to 14,829. The authenticated synthetic save/recovery/reopen passes, but these actions remain above the 200-attempt target. Full warmed/cold/concurrent performance and failure acceptance remain open. The earlier 0289 recovery-unknown observation is retained and unexplained, not fixed by later passing runs. |
