...
| C22 | I5 Save/reopen | Measured provider request load and end-to-end latency satisfy documented human-UX acceptance thresholds on the representative journey. | Pending | [0316](../intent/0316/EVIDENCE.md) reduces scope start 406→195 and recovery/repeat 460→221 attempts with effect-separated current-original reads. Only the first start is under 200 in functional samples. Scope preparation remains 292, first drafting preparation 532, drafting start 1,407; new-distinct preview/confirmation 330 / 853 and continuation 440 / 1,073. Next consolidate drafting-start originals and remaining preparation/confirmation controls, then the unchanged complete benchmark. No live UI acceptance; prior failures and the 0289 recovery observation remain. |
...
scheduling. Drafting-start current-original reads and remaining preparation/save
controls still need integration before the whole-action benchmark. Preview optimization alone cannot
