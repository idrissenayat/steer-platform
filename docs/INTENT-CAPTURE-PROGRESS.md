...
| C22 | I5 Save/reopen | Measured provider request load and end-to-end latency satisfy documented human-UX acceptance thresholds on the representative journey. | Pending | [0295](../intent/0295/EVIDENCE.md) reduces preview from 5,057 to 4,957 attempts and first confirmation from 10,307 to 10,107 (about 2%); reconstructed/repeated confirmation use 10,079 / 10,077. Source review remains 210, scope preparation 844, drafting preparation 4,350 / 3,900 and initial drafting start 7,871. The authenticated synthetic save/recovery/reopen and 1,468 broad tests pass, but the 200-attempt ceiling and full performance/live acceptance remain unmet. The prior delayed failure and unexplained 0289 recovery-unknown remain retained. |
