...
| C22 | I5 Save/reopen | Measured provider request load and end-to-end latency satisfy documented human-UX acceptance thresholds on the representative journey. | Pending | [0293](../intent/0293/EVIDENCE.md) reduces source review to 232 attempts, scope preparation to 932, first confirmation to 10,483, preview to 5,145 and drafting preparation to 4,438 / 3,988. Initial drafting start remains 7,871. The authenticated synthetic save/recovery/reopen passes, but the delayed source-review prefix still exceeds the 200-attempt limit. Full warmed/cold/concurrent performance and failure acceptance remain open. The earlier 0289 recovery-unknown observation remains retained and unexplained, not fixed by later passing runs. |
