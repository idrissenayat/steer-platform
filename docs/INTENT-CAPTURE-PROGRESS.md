...
| C22 | I5 Save/reopen | Measured provider request load and end-to-end latency satisfy documented human-UX acceptance thresholds on the representative journey. | Pending | [0292](../intent/0292/EVIDENCE.md) reduces first confirmation to 11,213 attempts, preview to 5,501, drafting preparation to 4,756 / 4,306 and initial drafting start to 7,871. Source review remains 317 and scope preparation 1,250. The authenticated synthetic save/recovery/reopen passes, but these actions remain above the 200-attempt target. Full warmed/cold/concurrent performance and failure acceptance remain open. The earlier 0289 recovery-unknown observation is retained and unexplained, not fixed by later passing runs. |
