...
test('0107: every copy and the tombstone require complete action, human and provider proofs with zero effects', () => {
  assert.deepEqual(Object.keys(fixtures).sort(), ['lifecycleGraphExecutionCase', 'lifecycleGraphVariants', 'lifecycleNegativeExecutionCase', 'specialLifecycleExecutionCase']);
