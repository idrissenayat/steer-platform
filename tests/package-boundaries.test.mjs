...
test('recorded development browser contracts transitively contain only portable validation, never dispatch, storage or provider code', async () => {
  ...
  pending.push('candidate-proposal-contracts.ts', 'candidate-save-preview-contracts.ts', 'candidate-save-prepare-contracts.ts', 'candidate-save-start-contracts.ts');
