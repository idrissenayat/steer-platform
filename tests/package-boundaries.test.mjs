...
const rules = {
  ...
  'apps/web': { folders: ['app'], packages: ['next', 'react', 'react-dom', 'react-markdown', '@steer/tool-registry'], builtins: [],
    specifiersOnly: { '@steer/tool-registry': ['@steer/tool-registry/intent-run-discovery-contracts', '@steer/tool-registry/intent-development-history-contracts', '@steer/tool-registry/intent-scope-history-contracts', '@steer/tool-registry/candidate-save-preview-contracts', '@steer/tool-registry/candidate-save-review-contracts', '@steer/tool-registry/candidate-save-status-contracts', '@steer/tool-registry/candidate-bundle-read-contracts', '@steer/tool-registry/intent-development-context', '@steer/tool-registry/intent-scope-selection', '@steer/tool-registry/intent-scope-discovery-contracts', '@steer/tool-registry/intent-scope-prepare-contracts', '@steer/tool-registry/intent-scope-start-contracts', '@steer/tool-registry/intent-scope-batches', '@steer/tool-registry/intent-scope-read-contracts', '@steer/tool-registry/intent-draft-discovery-contracts', '@steer/tool-registry/intent-development-review-contracts', '@steer/tool-registry/intent-development-prepare-contracts', '@steer/tool-registry/intent-development-start-contracts', '@steer/tool-registry/intent-development-read-contracts', '@steer/tool-registry/intent-draft-contracts', '@steer/tool-registry/intent-draft-content', '@steer/tool-registry/intent-revision-contracts', '@steer/tool-registry/intent-overlap-contracts', '@steer/tool-registry/agent-contracts', '@steer/tool-registry/projection-consumer', '@steer/tool-registry/brief-contracts', '@steer/tool-registry/decision-contracts', '@steer/tool-registry/lifecycle-contracts'] } },
...
test('recorded development browser contracts transitively contain only portable validation, never dispatch, storage or provider code', async () => {
  ...
  pending.push('candidate-save-preview-contracts.ts');
